...
class TestStemmingHelper(unittest.TestCase):
    @vcr.use_cassette('tests/vcr/helpers/stemming_helper.test_get_vote_format1.yml', record_mode='new_episodes')
    ...
    @vcr.use_cassette('tests/vcr/helpers/stemming_helper.test_get_vote_format2.yml', record_mode='new_episodes')
    def test_get_vote_format2(self):
        submission = reddit.client().submission(id='8mj3f6')
        format = StemmingHelper.get_format(submission.selftext)
        self.assertEqual(format, {'M0309', 'M0310', 'M0311'})

    @vcr.use_cassette('tests/vcr/helpers/stemming_helper.test_get_vote_format3.yml', record_mode='new_episodes')
    ...
    @vcr.use_cassette('tests/vcr/helpers/stemming_helper.test_get_vote_format_with_none.yml', record_mode='new_episodes')
    def test_get_vote_format_with_none(self):
        self.assertEqual(StemmingHelper.get_format(None), set())

    @vcr.use_cassette('tests/vcr/helpers/stemming_helper.test_get_votes1.yml', record_mode='new_episodes')
    ...
    @vcr.use_cassette('tests/vcr/helpers/stemming_helper.test_get_votes2.yml', record_mode='new_episodes')
    ...
    @vcr.use_cassette('tests/vcr/helpers/stemming_helper.test_get_votes3.yml', record_mode='new_episodes')
    ...
    @vcr.use_cassette('tests/vcr/helpers/stemming_helper.test_find_kamerstuk_submission.yml', record_mode='new_episodes')
    def test_find_kamerstuk_submission(self):
        self.assertEqual('8m3sph', StemmingHelper.find_kamerstuk_submission('M0311').id)

    @vcr.use_cassette('tests/vcr/helpers/stemming_helper.test_get_votes_with_none.yml', record_mode='new_episodes')
