...
class TestVoorzitterResponder(unittest.TestCase):
    @vcr.use_cassette('tests/vcr/responders/voorzitter_responder.test_nviv.yml', record_mode='new_episodes')
    ...
    @vcr.use_cassette('tests/vcr/responders/voorzitter_responder.test_dro.yml', record_mode='new_episodes')
